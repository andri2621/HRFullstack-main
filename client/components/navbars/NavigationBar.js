...
import codeidpng from './../../assets/images/hris.png'
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <a href="#" className={active === "dashboard" ? activeClass : disactiveClass} onClick={()=>setActive("dashboard")}>Dashboard</a>

                                    <a href="#" className={active === "team" ? activeClass : disactiveClass} onClick={()=>setActive("team")}>Our Team</a>

                                    <a href="#" className={active === "projects" ? activeClass : disactiveClass} onClick={()=>setActive("projects")}>Projects</a>

                                    <a href="#" className={active === "calendar" ? activeClass : disactiveClass} onClick={()=>setActive("calendar")}>Calendar</a>
